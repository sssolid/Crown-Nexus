...
class ProductProcessor(GenericProcessor[ProductCreate]):
    ...
    def _process_complex_field(self, processed_record: Dict[str, Any], original_record: Dict[str, Any],
                               complex_field: str, mappings: Dict[str, Any]) -> None:
        ...
        for field_name in field_names:
            ...
            if field_name in ['part_number', 'application', 'is_active', 'vintage', 'late_model', 'soft', 'universal',
                              'last_updated']:
                continue
