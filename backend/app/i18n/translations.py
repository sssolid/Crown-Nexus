...
class I18nManager:
    ...
    def _load_translations(self) -> None:
        ...
        default_domain = gettext.translation(
            "messages", locale_dir, languages=[self.default_locale], fallback=True
        )
        ...
        for locale in self.available_locales:
            ...
            try:
                domain = gettext.translation(
                    "messages", locale_dir, languages=[locale], fallback=False
                )
    ...
    def ngettext(
        self, singular: str, plural: str, n: int, locale: Optional[str] = None
    ) -> str:
        """
...
class TranslatorDependency:
    ...
    async def __call__(self, locale: str = Depends(get_locale)) -> Dict[str, Any]:
        ...
        return {
            ...
            "_n": lambda singular, plural, n: i18n_manager.ngettext(
                singular, plural, n, final_locale
            ),
            "locale": final_locale,
        }
