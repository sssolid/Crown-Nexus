...
class TimeoutMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        Args:
            ...
            timeout_seconds: The maximum request duration in seconds
            exclude_paths: Paths to exclude from timeout enforcement
        """
        super().__init__(app)
    ...
    async def dispatch(self, request: Request, call_next: Callable[[Request], Response]) -> Response:
        ...
        Returns:
            Response: The response, or a timeout error response
        """
