...
class VehicleDataService:
    ...
    async def get_models(self, make: Optional[str]=None, year: Optional[int]=None) -> List[str]:
        ...
        try:
            ...
            logger.error("Failed to retrieve vehicle models",
                         make=make, year=year, error=str(e), exc_info=True)
            raise DatabaseException(
    ...
    async def get_engines(self, make: Optional[str]=None, model: Optional[str]=None, year: Optional[int]=None) -> List[str]:
        ...
        try:
            ...
            logger.error("Failed to retrieve vehicle engines",
                         make=make, model=model, year=year, error=str(e), exc_info=True)
            raise DatabaseException(
    ...
    async def get_transmissions(self, make: Optional[str]=None, model: Optional[str]=None,
                                year: Optional[int]=None, engine: Optional[str]=None) -> List[str]:
        ...
        try:
            ...
            logger.debug(f"Retrieved {len(transmissions)} vehicle transmissions",
                         make=make, model=model, year=year, engine=engine)
            return transmissions
        except SQLAlchemyError as e:
            logger.error("Failed to retrieve vehicle transmissions",
                         make=make, model=model, year=year, engine=engine, error=str(e), exc_info=True)
            raise DatabaseException(
    ...
    async def validate_fitment(self, year: int, make: str, model: str,
                               engine: Optional[str]=None, transmission: Optional[str]=None) -> bool:
        ...
        try:
            ...
            logger.debug("Validated fitment",
            ...
            logger.error("Failed to validate fitment",
                         year=year, make=make, model=model, error=str(e), exc_info=True)
            raise DatabaseException(
