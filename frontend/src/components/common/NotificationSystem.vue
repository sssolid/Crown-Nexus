<!-- frontend/src/components/common/NotificationSystem.vue -->
<template>
  <div class="notification-container">
    ...
    >
      <div class="d-flex align-center">
        <v-icon v-if="notification.type === 'success'" icon="mdi-check-circle" class="mr-2"></v-icon>
        <v-icon v-if="notification.type === 'error'" icon="mdi-alert-circle" class="mr-2"></v-icon>
        <v-icon v-if="notification.type === 'warning'" icon="mdi-alert" class="mr-2"></v-icon>
        <v-icon v-if="notification.type === 'info'" icon="mdi-information" class="mr-2"></v-icon>
...
import { notificationService, Notification, NotificationType } from '@/utils/notification';
...
export default defineComponent({
  ...
  setup() {
    ...
    // Watch for new notifications and set their visibility to true
    watch(notifications, (newNotifications) => {
      ...
      // Clean up old notifications from visibility tracking
