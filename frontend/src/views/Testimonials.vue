      ...
      try {
        ...
        const mockTestimonials: Testimonial[] = [
          ...
          },
          {
            ...
            rating: 5,
            image_url: 'https://via.placeholder.com/800x600?text=GT+Performance+Case+Study',
            is_featured: false,
          ...
          },
          {
            ...
            rating: 4,
            image_url: 'https://via.placeholder.com/800x600?text=Pacific+Auto+Case+Study',
            is_featured: false,
          ...
          },
          {
            ...
            rating: 5,
            image_url: 'https://via.placeholder.com/800x600?text=Midwest+Auto+Case+Study',
            is_featured: false,
          ...
          },
          {
            ...
            rating: 4,
            image_url: 'https://via.placeholder.com/800x600?text=CityWide+Case+Study',
            is_featured: false,
          ...
          },
          {
            ...
            rating: 5,
            image_url: 'https://via.placeholder.com/800x600?text=Velocity+Case+Study',
            is_featured: false,
