...
async def read_products(db: Annotated[AsyncSession, Depends(get_db)], current_user: Annotated[User, Depends(get_current_active_user)], search: Optional[str]=None, vintage: Optional[bool]=None, late_model: Optional[bool]=None, soft: Optional[bool]=None, universal: Optional[bool]=None, is_active: Optional[bool]=None, skip: int=0, limit: int=100, page: int=1, page_size: int=20, sort_by: Optional[str]=None, sort_desc: Optional[bool]=False) -> Any:
    ...
    if sort_by:
        sort_field_map = {'part_number': Product.part_number, 'is_active': Product.is_active, 'vintage': Product.vintage, 'late_model': Product.late_model, 'soft': Product.soft, 'universal': Product.universal, 'application': Product.application}
