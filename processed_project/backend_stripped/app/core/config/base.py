...
class BaseAppSettings(BaseSettings):
    ...
    LOG_FORMAT: str = 'text'
    MIDDLEWARE_EXCLUDE_PATHS: List[str] = ['/api/v1/docs', '/api/v1/redoc', '/api/v1/openapi.json', '/static/', '/media/']
    ...
    DEFAULT_CACHE_CONTROL: str = os.getenv('DEFAULT_CACHE_CONTROL', 'no-store, no-cache, must-revalidate, max-age=0')
    CACHE_RULES: Dict[str, str] = {'/static/': 'public, max-age=86400, stale-while-revalidate=3600', '/media/': 'public, max-age=86400, stale-while-revalidate=3600', '/api/v1/docs': 'public, max-age=3600', '/api/v1/redoc': 'public, max-age=3600', '/api/v1/openapi.json': 'public, max-age=3600', '/api/v1/health': 'public, max-age=60'}
