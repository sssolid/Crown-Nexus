...
class ResourceException(AppException):
    def __init__(self, message: str, code: ErrorCode=ErrorCode.RESOURCE_NOT_FOUND, details: Any=None, status_code: int=404, original_exception: Optional[Exception]=None) -> None:
...
class ResourceNotFoundException(ResourceException):
    def __init__(self, resource_type: str, resource_id: str, message: Optional[str]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
        if message is None:
...
class ResourceAlreadyExistsException(ResourceException):
    def __init__(self, resource_type: str, identifier: str, field: str='id', message: Optional[str]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
        if message is None:
...
class AuthException(AppException):
    def __init__(self, message: str, code: ErrorCode, details: Any=None, status_code: int=401, original_exception: Optional[Exception]=None) -> None:
...
class AuthenticationException(AuthException):
    def __init__(self, message: str='Authentication failed', details: Any=None, original_exception: Optional[Exception]=None) -> None:
...
class PermissionDeniedException(AuthException):
    def __init__(self, message: str='Permission denied', action: Optional[str]=None, resource_type: Optional[str]=None, permission: Optional[str]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
...
class ValidationException(AppException):
    def __init__(self, message: str='Validation error', errors: Optional[List[Dict[str, Any]]]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
...
class BusinessException(AppException):
    def __init__(self, message: str, code: ErrorCode=ErrorCode.BUSINESS_LOGIC_ERROR, details: Any=None, status_code: int=400, original_exception: Optional[Exception]=None) -> None:
...
class InvalidStateException(BusinessException):
    def __init__(self, message: str, current_state: Optional[str]=None, expected_state: Optional[str]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
        error_details = details or {}
        if current_state:
...
class OperationNotAllowedException(BusinessException):
    def __init__(self, message: str, operation: Optional[str]=None, reason: Optional[str]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
        error_details = details or {}
        if operation:
