...
class SystemException(AppException):
    def __init__(self, message: str, code: ErrorCode=ErrorCode.UNKNOWN_ERROR, details: Any=None, status_code: int=500, original_exception: Optional[Exception]=None) -> None:
...
class DatabaseException(SystemException):
    def __init__(self, message: str, code: ErrorCode=ErrorCode.DATABASE_ERROR, details: Any=None, status_code: int=500, original_exception: Optional[Exception]=None) -> None:
...
class DataIntegrityException(DatabaseException):
    def __init__(self, message: str, details: Any=None, original_exception: Optional[Exception]=None) -> None:
...
class NetworkException(SystemException):
    def __init__(self, message: str, details: Any=None, status_code: int=503, original_exception: Optional[Exception]=None) -> None:
...
class ServiceException(SystemException):
    def __init__(self, message: str, service_name: Optional[str]=None, details: Any=None, status_code: int=502, original_exception: Optional[Exception]=None) -> None:
...
class ConfigurationException(SystemException):
    def __init__(self, message: str, component: Optional[str]=None, details: Any=None, original_exception: Optional[Exception]=None) -> None:
        error_details = details or {}
        if component:
...
class SecurityException(SystemException):
    def __init__(self, message: str, details: Any=None, status_code: int=403, original_exception: Optional[Exception]=None) -> None:
...
class RateLimitException(SecurityException):
    def __init__(self, message: str='Rate limit exceeded', details: Any=None, headers: Optional[Dict[str, str]]=None, original_exception: Optional[Exception]=None) -> None:
        error_details = details or {}
