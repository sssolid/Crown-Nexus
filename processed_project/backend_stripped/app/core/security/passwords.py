...
async def validate_password_policy(password: str, user_id: Optional[str]=None) -> Tuple[bool, Optional[str]]:
    ...
    if len(password) > policy.max_length:
        return (False, f'Password cannot be longer than {policy.max_length} characters')
...
def _load_common_passwords() -> Set[str]:
    ...
    try:
        ...
        if passwords_file.exists():
            ...
            common_passwords = {'password', '123456', '123456789', 'qwerty', '12345678', '111111', '1234567890', '1234567', 'password1', '12345', '123123', '000000', 'iloveyou', '1234', '1q2w3e4r', 'admin'}
            logger.debug(f'Using default list of {len(common_passwords)} common passwords')
    except Exception as e:
        logger.error(f'Error loading common passwords: {str(e)}')
        common_passwords = {'password', '123456', '123456789', 'qwerty', '12345678'}
    return common_passwords
class PasswordManager:
    def __init__(self) -> None:
        self.policy = PasswordPolicy()
        self.common_passwords: Set[str] = set()
        self.password_regex = re.compile('^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$')
    ...
    def _load_common_passwords_sync(self) -> None:
        try:
            ...
            if passwords_file.exists():
                ...
                self.common_passwords = {'password', '123456', '123456789', 'qwerty', '12345678', '111111', '1234567890', '1234567', 'password1', '12345', '123123', '000000', 'iloveyou', '1234', '1q2w3e4r', 'admin'}
