        ...
        try:
            ...
            if hasattr(product_data, 'descriptions') and product_data.descriptions:
                ...
                for desc in product_data.descriptions:
                    ...
                    logger.debug(f'Added {desc.description_type} description for {product_data.part_number}: {desc.description[:30]}...')
            else:
            ...
            if hasattr(product_data, 'marketing') and product_data.marketing:
                ...
                for mkt in product_data.marketing:
                    ...
                    logger.debug(f'Added {mkt.marketing_type} marketing for {product_data.part_number}: {mkt.content[:30]}...')
            else:
