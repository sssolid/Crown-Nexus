...
class PipeFileImporter(Generic[T]):
    def __init__(self, db: AsyncSession, source_path: Path, schema_name: str, required_files: List[str], version_class: Type[Base], version_date_field: str='version_date', batch_size: int=1000, encoding: str='utf-8', delimiter: str='|') -> None:
        self.db = db
