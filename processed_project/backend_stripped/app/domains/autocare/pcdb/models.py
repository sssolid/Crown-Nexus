...
class Parts(Base):
    ...
    parts_description_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey('autocare_parts_description.parts_description_id'), nullable=True)
    ...
    supersessions = relationship('PartsSupersession', foreign_keys='[PartsSupersession.new_part_terminology_id]', primaryjoin='Parts.part_terminology_id==PartsSupersession.new_part_terminology_id', backref='new_part')
    superseded_by = relationship('PartsSupersession', foreign_keys='[PartsSupersession.old_part_terminology_id]', primaryjoin='Parts.part_terminology_id==PartsSupersession.old_part_terminology_id', backref='old_part')
...
class PartCategory(Base):
    ...
    part_terminology_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_parts.part_terminology_id'), nullable=False)
    subcategory_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_subcategory.subcategory_id'), nullable=False)
    category_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_category.category_id'), nullable=False)
...
class PartPosition(Base):
    ...
    part_terminology_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_parts.part_terminology_id'), nullable=False)
    position_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_position.position_id'), nullable=False)
    rev_date: Mapped[Optional[date]] = mapped_column(Date, nullable=True)
...
class PartsSupersession(Base):
    ...
    old_part_terminology_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_parts.part_terminology_id'), nullable=False)
    old_part_terminology_name: Mapped[str] = mapped_column(String(256), nullable=False)
    new_part_terminology_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_parts.part_terminology_id'), nullable=False)
...
parts_to_alias = Table('autocare_parts_to_alias', Base.metadata, mapped_column('part_terminology_id', Integer, ForeignKey('autocare_parts.part_terminology_id'), primary_key=True), mapped_column('alias_id', Integer, ForeignKey('autocare_alias.alias_id'), primary_key=True))
class Use(Base):
...
parts_to_use = Table('autocare_parts_to_use', Base.metadata, mapped_column('part_terminology_id', Integer, ForeignKey('autocare_parts.part_terminology_id'), primary_key=True), mapped_column('use_id', Integer, ForeignKey('autocare_use.use_id'), primary_key=True))
