...
class PartsSupersession(Base):
    ...
    old_part_terminology_id: Mapped[int] = mapped_column(Integer, ForeignKey('pcdb.parts.part_terminology_id'), nullable=False)
    old_part_terminology_name: Mapped[str] = mapped_column(String(256), nullable=False)
    new_part_terminology_id: Mapped[int] = mapped_column(Integer, ForeignKey('pcdb.parts.part_terminology_id'), nullable=False)
