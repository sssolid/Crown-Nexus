...
class Qualifier(Base):
    ...
    new_qualifier_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey('qdb.qualifier.qualifier_id'), nullable=True)
    ...
    superseded_by = relationship('Qualifier', primaryjoin='foreign(qdb.Qualifier.new_qualifier_id) == remote(qdb.Qualifier.qualifier_id)', backref='supersedes', remote_side='qdb.Qualifier.qualifier_id')
    def __repr__(self) -> str:
