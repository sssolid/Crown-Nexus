...
class Qualifier(Base):
    ...
    qualifier_type_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_qualifier_type.qualifier_type_id'), nullable=False)
    new_qualifier_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey('autocare_qualifier.qualifier_id'), nullable=True)
    ...
    superseded_by = relationship('Qualifier', remote_side=[id], foreign_keys=[new_qualifier_id], backref='supersedes')
    def __repr__(self) -> str:
...
class QualifierTranslation(Base):
    ...
    qualifier_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_qualifier.qualifier_id'), nullable=False)
    language_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_language.language_id'), nullable=False)
...
class QualifierGroup(Base):
    ...
    group_number_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_group_number.group_number_id'), nullable=False)
    qualifier_id: Mapped[int] = mapped_column(Integer, ForeignKey('autocare_qualifier.qualifier_id'), nullable=False)
