...
class Make(Base):
    ...
    vehicles = relationship('Vehicle', secondary='base_vehicle', primaryjoin='Make.make_id == foreign(vcdb.BaseVehicle.make_id)', secondaryjoin='foreign(vcdb.Vehicle.base_vehicle_id) == vcdb.BaseVehicle.base_vehicle_id', viewonly=True, overlaps='make,base_vehicle')
...
class Region(Base):
    ...
    parent = relationship('Region', remote_side='Region.region_id', back_populates='children')
...
class Vehicle(Base):
    ...
    brake_configs = relationship('BrakeConfig', secondary='vehicle_to_brake_config')
    bed_configs = relationship('BedConfig', secondary='vehicle_to_bed_config')
    body_style_configs = relationship('BodyStyleConfig', secondary='vehicle_to_body_style_config')
    mfr_body_codes = relationship('MfrBodyCode', secondary='vehicle_to_mfr_body_code')
    engine_configs = relationship('EngineConfig', secondary='vehicle_to_engine_config')
    spring_type_configs = relationship('SpringTypeConfig', secondary='vehicle_to_spring_type_config')
    steering_configs = relationship('SteeringConfig', secondary='vehicle_to_steering_config')
    transmissions = relationship('Transmission', secondary='vehicle_to_transmission')
...
vehicle_to_drive_type = Table('vehicle_to_drive_type', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('drive_type_id', Integer, ForeignKey('vcdb.drive_type.drive_type_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
class BrakeType(Base):
    ...
    name: Mapped[str] = mapped_column(String(30), nullable=False, index=True)
    front_brake_configs = relationship('BrakeConfig', foreign_keys='[vcdb.BrakeConfig.front_brake_type_id]', back_populates='front_brake_type')
    rear_brake_configs = relationship('BrakeConfig', foreign_keys='[vcdb.BrakeConfig.rear_brake_type_id]', back_populates='rear_brake_type')
    def __repr__(self) -> str:
...
class BrakeConfig(Base):
    ...
    front_brake_type = relationship('BrakeType', foreign_keys='[vcdb.front_brake_type_id]', back_populates='front_brake_configs')
    rear_brake_type = relationship('BrakeType', foreign_keys='[vcdb.rear_brake_type_id]', back_populates='rear_brake_configs')
...
vehicle_to_brake_config = Table('vehicle_to_brake_config', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('brake_config_id', Integer, ForeignKey('vcdb.brake_config.brake_config_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
class BedType(Base):
...
vehicle_to_bed_config = Table('vehicle_to_bed_config', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('bed_config_id', Integer, ForeignKey('vcdb.bed_config.bed_config_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
class BodyType(Base):
...
vehicle_to_body_style_config = Table('vehicle_to_body_style_config', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('body_style_config_id', Integer, ForeignKey('vcdb.body_style_config.body_style_config_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
...
vehicle_to_mfr_body_code = Table('vehicle_to_mfr_body_code', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('mfr_body_code_id', Integer, ForeignKey('vcdb.mfr_body_code.mfr_body_code_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
...
vehicle_to_engine_config = Table('vehicle_to_engine_config', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('engine_config_id', Integer, ForeignKey('vcdb.engine_config.engine_config_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
class SpringType(Base):
    ...
    name: Mapped[str] = mapped_column(String(50), nullable=False, index=True)
    front_spring_configs = relationship('SpringTypeConfig', foreign_keys='[vcdb.SpringTypeConfig.front_spring_type_id]', back_populates='front_spring_type')
    rear_spring_configs = relationship('SpringTypeConfig', foreign_keys='[vcdb.SpringTypeConfig.rear_spring_type_id]', back_populates='rear_spring_type')
    def __repr__(self) -> str:
...
class SpringTypeConfig(Base):
    ...
    front_spring_type = relationship('SpringType', foreign_keys='[vcdb.front_spring_type_id]', back_populates='front_spring_configs')
    rear_spring_type = relationship('SpringType', foreign_keys='[vcdb.rear_spring_type_id]', back_populates='rear_spring_configs')
    def __repr__(self) -> str:
        return f'<SpringTypeConfig {self.spring_type_config_id}>'
vehicle_to_spring_type_config = Table('vehicle_to_spring_type_config', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('spring_type_config_id', Integer, ForeignKey('vcdb.spring_type_config.spring_type_config_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
...
vehicle_to_steering_config = Table('vehicle_to_steering_config', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('steering_config_id', Integer, ForeignKey('vcdb.steering_config.steering_config_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
...
vehicle_to_transmission = Table('vehicle_to_transmission', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('transmission_id', Integer, ForeignKey('vcdb.transmission.transmission_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
...
vehicle_to_wheel_base = Table('vehicle_to_wheel_base', Base.metadata, Column('id', UUID(as_uuid=True), primary_key=True, default=uuid.uuid4), Column('vehicle_id', Integer, ForeignKey('vcdb.vehicle.vehicle_id'), nullable=False), Column('wheel_base_id', Integer, ForeignKey('vcdb.wheel_base.wheel_base_id'), nullable=False), Column('source', String(10), nullable=True), schema='vcdb')
