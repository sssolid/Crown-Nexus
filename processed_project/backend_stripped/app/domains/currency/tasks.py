...
def init_currencies() -> Dict[str, Optional[int]]:
    currencies = [{'code': 'USD', 'name': 'US Dollar', 'symbol': '$', 'is_base': True}, {'code': 'EUR', 'name': 'Euro', 'symbol': '€', 'is_base': False}, {'code': 'GBP', 'name': 'British Pound', 'symbol': '£', 'is_base': False}, {'code': 'JPY', 'name': 'Japanese Yen', 'symbol': '¥', 'is_base': False}, {'code': 'CAD', 'name': 'Canadian Dollar', 'symbol': 'C$', 'is_base': False}, {'code': 'AUD', 'name': 'Australian Dollar', 'symbol': 'A$', 'is_base': False}, {'code': 'CHF', 'name': 'Swiss Franc', 'symbol': 'CHF', 'is_base': False}, {'code': 'CNY', 'name': 'Chinese Yuan', 'symbol': '¥', 'is_base': False}]
