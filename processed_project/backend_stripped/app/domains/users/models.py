...
class User(Base):
    ...
    uploaded_media = relationship('Media', foreign_keys='[media.Media.uploaded_by_id]', back_populates='uploaded_by')
    approved_media = relationship('Media', foreign_keys='[media.Media.approved_by_id]', back_populates='approved_by')
