        ...
        try:
            ...
            for rule in applicable_rules:
                ...
                if self.enable_headers:
                    if 'X-RateLimit-Remaining' not in headers or int(headers['X-RateLimit-Remaining']) > limit - count:
            ...
            if is_limited and self.block_exceeding_requests:
                ...
                return JSONResponse(content={'error': 'Rate limit exceeded'}, status_code=429, headers=headers)
