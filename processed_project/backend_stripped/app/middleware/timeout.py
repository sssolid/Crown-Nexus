...
class TimeoutMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable[[Request], Response]) -> Response:
        ...
        try:
            ...
            raise TimeoutException(message=f'Request timed out after {self.timeout_seconds} seconds', details={'endpoint': path, 'method': request.method, 'timeout_seconds': self.timeout_seconds})
        finally:
