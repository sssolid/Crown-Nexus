...
Generated on 2025-03-21 21:07:22
...
from app.schemas.user import Company as CompanySchema, User as UserSchema, UserCreate, UserUpdate
...
Args: name: The name of the dependency **kwargs: Additional arguments to pass to the service provider if needed
...
Args: service_name: The name of the service db: Optional database session to pass to the service
...
Args: dependency_name: The name of the dependency to inject
...
Args: provider: The service provider function name: Optional name for the service (defaults to function name)
...
```python
    def __new__(cls) -> DependencyManager:
        """Create a singleton instance of the dependency manager.  Returns: The singleton instance"""
```
```python
    def clear(self) -> None:
...
```python
    def clear_instance(self, name) -> None:
        """Clear a specific dependency instance.  Args: name: The name of the dependency to clear"""
```
```python
...
Args: db: Optional database session to pass to services

Returns: A dictionary of service names to service instances"""
```
```python
    def get_instance(self, cls, **kwargs) -> T:
        """Get an instance of a specific class.

Args: cls: The class to get an instance of **kwargs: Additional arguments to pass to the service provider if needed

Returns: An instance of the specified class"""
```
```python
    async def initialize_services(self) -> None:
        """Initialize all registered services.  This calls the initialize method on each service that has one."""
```
```python
    def register_dependency(self, name, instance) -> None:
        """Register a dependency instance with the manager.

Args: name: The name of the dependency instance: The dependency instance"""
```
```python
    def register_service(self, provider, name) -> None:
        """Register a service provider function.

Args: provider: A callable that creates the service name: The name of the service"""
```
```python
    async def shutdown_services(self) -> None:
        """Shutdown all registered services.  This calls the shutdown method on each service that has one."""
```
...
Args: key_func: Function to generate cache key ttl: Time-to-live in seconds backend: Optional cache backend name tags: Optional list of tags for cache invalidation
...
Args: ttl: Time-to-live in seconds prefix: Cache key prefix backend: Optional cache backend name skip_args: Optional list of argument indices to skip in key generation skip_kwargs: Optional list of keyword argument names to skip in key generation tags: Optional list of tags for cache invalidation
...
Args: pattern: Cache key pattern to invalidate prefix: Cache key prefix backend: Optional cache backend name tags: Optional list of tags to invalidate
...
Args: ttl: Optional time-to-live in seconds max_size: Maximum cache size
...
Args: name: Backend name (defaults to the configured default backend)

Returns: CacheBackend: The requested cache backend
...
**Global Variables:**
```python
logger = logger = logging.getLogger("app.core.config.as400")
...
Returns: List of default error reporters"""
```
```python
@classmethod
...
Args: reporter_type: Type of reporter to create ('logging', 'database', 'external') **kwargs: Additional arguments for the reporter

Returns: An instance of the specified reporter

Raises: ValueError: If reporter type is not supported"""
```
...
Args: value: Value to check resource_type: Type of resource resource_id: ID of the resource message: Optional custom error message

Returns: The value if not None

Raises: ResourceNotFoundException: If value is None"""
```
...
Args: exception: Exception to handle request_id: Optional request ID for tracking"""
```

```python
async def initialize() -> None:
    """Initialize the error handling system.  This function sets up the default error reporters."""
```
...
Args: action: Action being attempted resource_type: Type of resource permission: Required permission

Returns: PermissionDeniedException"""
```

```python
def register_reporter(reporter) -> None:
    """Register a new error reporter.  Args: reporter: Error reporter to register"""
```
...
Args: exception: Exception to report context: Context information for the error"""
```
...
Args: resource_type: Type of resource identifier: Value of the identifier field: Field name that must be unique message: Optional custom error message
...
Args: resource_type: Type of resource resource_id: ID of the resource message: Optional custom error message
...
Args: field: Field with the validation error message: Validation error message error_type: Type of validation error
...
Args: service_url: URL of the error tracking service API api_key: API key for authentication"""
```
```python
    async def report_error(self, exception, context) -> None:
...
This class provides the foundation for the application's exception hierarchy, with standardized error codes, messages, and HTTP status codes."""
```
*Methods:*
```python
...
Args: message: Human-readable error message code: Error code from ErrorCode enum details: Additional error details or context status_code: HTTP status code to return severity: Error severity level category: Error category for classification original_exception: Original exception that caused this error"""
```
```python
...
These codes provide a consistent way to identify error types across the application, allowing clients to handle errors in a structured way."""
```
*Class attributes:*
```python
...
Args: message: Human-readable error message code: Error code details: Additional error details status_code: HTTP status code original_exception: Original exception"""
```
...
Args: message: Human-readable error message details: Additional error details original_exception: Original exception"""
```
...
Args: message: Human-readable error message current_state: Current state of the entity expected_state: Expected state for the operation details: Additional error details original_exception: Original exception"""
```
...
Args: message: Human-readable error message operation: Attempted operation reason: Reason why the operation is not allowed details: Additional error details original_exception: Original exception"""
```
...
Args: message: Human-readable error message action: Attempted action (e.g., "create", "update") resource_type: Type of resource being accessed permission: Required permission details: Additional error details original_exception: Original exception"""
```
...
Args: resource_type: Type of resource (e.g., "User", "Product") identifier: Value of the unique identifier field: Name of the field that must be unique message: Custom error message (optional) details: Additional error details original_exception: Original exception"""
```
...
Args: resource_type: Type of resource (e.g., "User", "Product") resource_id: ID of the resource message: Custom error message (optional) details: Additional error details original_exception: Original exception"""
```
...
Args: message: Human-readable error message errors: List of validation errors details: Additional error details original_exception: Original exception"""
```
...
Converts AppException instances to standardized error responses with appropriate status codes.

Args: request: FastAPI request object exc: Application exception
...
Converts any unhandled exception to a standardized error response with a 500 status code.

Args: request: FastAPI request object exc: Unhandled exception
...
Converts validation errors to a standardized format with details about each validation error.

Args: request: FastAPI request object exc: Validation exception
...
Args: message: Human-readable error message component: Component with configuration error details: Additional error details original_exception: Original exception"""
```
...
Args: message: Human-readable error message details: Additional error details status_code: HTTP status code original_exception: Original exception"""
```
...
Args: message: Human-readable error message details: Additional error details headers: HTTP headers to include in the response original_exception: Original exception"""
```
...
Args: message: Human-readable error message service_name: Name of the external service details: Additional error details status_code: HTTP status code original_exception: Original exception"""
```
...
Args: db: Database session model_class: SQLAlchemy model class query: SQLAlchemy select query params: Pagination parameters transform_func: Optional function to transform each result item response_model: Optional Pydantic response model
...
Args: validator_type: The type of validator to create **options: Configuration options for the validator

Returns: Validator: An instance of the specified validator

Raises: ValueError: If the validator type is not supported"""
```
...
```python
    def __init__(self, db) -> None:
        """Initialize the unique validator.  Args: db: Database session"""
```
```python
...
Since this validator requires async database operations, this method raises an exception if called directly.

Args: value: The value to validate field: The field name to check model: The SQLAlchemy model class exclude_id: Optional ID to exclude from the check **kwargs: Additional validation parameters

Raises: RuntimeError: Always, as this validator requires async operations"""
```
```python
...
Args: name: Validator type name validator_class: Validator class

Raises: ValueError: If a validator with the same name is already registered"""
```
...
Args: rule_type: The type of validation rule **params: Parameters for the validation rule

Returns: A validator function that takes a value and returns a boolean"""
```
...
Args: name: The name of the validator validator_class: The validator class"""
```
...
Args: data: The data dictionary containing fields to validate rules: Dictionary mapping field names to validation rules

Returns: Tuple of (success, errors) where success is a boolean and errors is a list of error details"""
```
...
Args: value: The date to validate min_date: Optional minimum date max_date: Optional maximum date format_str: Optional date format string for parsing string dates

Returns: True if the date is valid and meets constraints, False otherwise"""
```
...
Returns: True if the string length meets constraints, False otherwise"""
```
...
Args: model: The Pydantic model instance to validate include: Set of fields to include in validation exclude: Set of fields to exclude from validation
...
Args: password: The password to validate min_length: Minimum password length require_lowercase: Whether to require at least one lowercase letter require_uppercase: Whether to require at least one uppercase letter require_digit: Whether to require at least one digit require_special: Whether to require at least one special character
...
Returns: True if the value meets range constraints, False otherwise"""
```
...
Args: field: The field name to check value: The value to check for uniqueness model: The SQLAlchemy model class db: The database session exclude_id: Optional ID to exclude from the check
...
from app.services.as400_sync_service import as400_sync_service, SyncEntityType, SyncStatus
from app.db.session import get_db_context
```
...
from app.models.user import User, UserRole
from app.models.reference import Color, ConstructionType, Hardware, PackagingType, Texture, TariffCode, UnspscCode, Warehouse
from app.models.currency import Currency, ExchangeRate
from app.models.media import Media, MediaType, MediaVisibility
from app.models.product import Product, Brand, Fitment, Manufacturer, PriceType, AttributeDefinition, ProductActivity, ProductAttribute, ProductBrandHistory, ProductDescription, ProductMarketing, ProductMeasurement, ProductPricing, ProductStock, ProductSupersession
from app.models.audit import AuditLog
from app.models.compliance import Prop65Chemical, ProductChemical, ChemicalType, ProductDOTApproval, ApprovalStatus, ExposureScenario, HazardousMaterial, TransportRestriction, Warning
from app.models.model_mapping import ModelMapping
from app.models.chat import ChatRoom, ChatMember, ChatRoomType, ChatMemberRole, ChatMessage, MessageReaction, MessageType, RateLimitLog
...
import uuid
from datetime import datetime
from typing import Any, AsyncGenerator, Callable, Dict, Generic, List, Optional, Sequence, Tuple, Type, TypeVar, Union, cast, overload
...
##### Module: api_key
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/models/api_key.py`
...
##### Module: audit
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/models/audit.py`
...
##### Module: company
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/models/company.py`
...
from app.models.company import Company
from app.models.reference import Color, ConstructionType, Hardware, PackagingType, TariffCode, Texture, UnspscCode
...
##### Module: sync_history
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/models/sync_history.py`
...
##### Module: api_key_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/api_key_repository.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/audit_repository.py`
...
##### Module: chat_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/chat_repository.py`
...
from sqlalchemy.ext.asyncio import AsyncSession
from app.models.chat import ChatRoom, ChatMember, ChatMessage, MessageReaction, RateLimitLog, ChatRoomType, ChatMemberRole, MessageType
from app.repositories.base import BaseRepository
...
##### Module: company_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/company_repository.py`
...
##### Module: compliance_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/compliance_repository.py`
...
from sqlalchemy import select, and_, or_, func, desc
from sqlalchemy.ext.asyncio import AsyncSession
from app.models.compliance import Prop65Chemical, Warning, ProductChemical, ProductDOTApproval, HazardousMaterial, ApprovalStatus, ChemicalType, ExposureScenario
from app.repositories.base import BaseRepository
from app.core.exceptions import ResourceNotFoundException
```
...
##### Module: currency_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/currency_repository.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/location_repository.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/media_repository.py`
...
##### Module: model_mapping_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/model_mapping_repository.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/product_repository.py`
...
from sqlalchemy.ext.asyncio import AsyncSession
from sqlalchemy.sql import Select
from app.models.product import Product, Brand, Fitment, ProductDescription, ProductActivity, ProductSupersession, ProductMeasurement, ProductStock
from app.repositories.base import BaseRepository
from app.core.exceptions import ResourceNotFoundException, BusinessException
```
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/reference_repository.py`
...
from sqlalchemy.ext.asyncio import AsyncSession
from app.models.reference import Color, ConstructionType, Texture, PackagingType, Hardware, TariffCode, UnspscCode, Warehouse
from app.repositories.base import BaseRepository
from app.core.exceptions import ResourceNotFoundException
```
...
##### Module: sync_history_repository
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/sync_history_repository.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/repositories/user_repository.py`
...
##### Module: address
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/address.py`
...
Attributes: street: Street address including number and name. city: City name. state: State or province name. postal_code: Postal or ZIP code. country_id: ID of the associated country."""
```
...
##### Module: api_key
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/api_key.py`
...
##### Module: audit
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/audit.py`
...
##### Module: company
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/company.py`
...
##### Module: compliance
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/compliance.py`
...
from typing import Any, Dict, List, Optional
from pydantic import BaseModel, ConfigDict, Field
from app.models.compliance import ChemicalType, ExposureScenario, ApprovalStatus, TransportRestriction
```
...
##### Module: country
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/country.py`
...
Args: v: The code value to validate.
...
Returns: Uppercase version of the code or None if not provided."""
```
...
##### Module: location
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/location.py`
...
##### Module: reference
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/schemas/reference.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/product_service.py`
...
##### Package: audit
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit`

**__init__.py:**
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit/__init__.py`
...
###### Module: base
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit/base.py`
...
###### Module: factory
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit/factory.py`
...
###### Module: loggers
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit/loggers.py`
...
###### Module: query
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit/query.py`
...
**Global Variables:**
```python
logger = logger = get_logger("app.services.audit.query")
```
...
###### Module: service
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/audit/service.py`
...
**Global Variables:**
```python
logger = logger = get_logger("app.services.audit.service")
```
...
##### Package: media
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media`

**__init__.py:**
*Media service package for handling file storage operations.*
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/__init__.py`
...
**Global Variables:**
```python
__all__ = __all__ = ["get_media_service", "MediaService"]
```
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/base.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/factory.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/local.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/s3.py`
...
from app.core.logging import get_logger
from app.models.media import MediaType
from app.services.media.base import FileNotFoundError, MediaStorageBackend, MediaStorageError, StorageConnectionError
from app.services.media.thumbnails import ThumbnailGenerator
```
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/service.py`
...
Path: `/home/runner/work/Crown-Nexus/Crown-Nexus/backend/app/services/media/thumbnails.py`
...
from app.core.exceptions import NetworkException, RateLimitException, ServiceException, ErrorCode
from app.core.logging import get_logger
```
