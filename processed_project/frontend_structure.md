...
| default | Any | No | - |
| false | Any | No | - |
| modelValue | [Array, Number, String] | No | null |
...
### UserAvatar
**Path:** `src/components/display/UserAvatar.vue`
**Type:** Composition API (script setup)
...
| String | Any | No | - |
| account | Any | No | - |
| backgroundColor | String | No | 'primary' |
| circle | Any | No | - |
| false | Any | No | - |
| icon | String | No | 'mdi-account' |
| name | String | No | '' |
| offline | Any | No | - |
| primary | Any | No | - |
| rounded | [Boolean, String] | No | 'circle' |
| showName | Boolean | No | false |
| showStatus | Boolean | No | false |
| string | Any | No | - |
...
### VehicleDetails
**Path:** `src/components/autocare/vcdb/VehicleDetails.vue`
**Type:** Composition API (script setup)
...
### VehicleDetailsView
**Path:** `src/views/autocare/vcdb/VehicleDetailsView.vue`
**Type:** Composition API (script setup)
...
### VehicleSearch
**Path:** `src/components/autocare/vcdb/VehicleSearch.vue`
**Type:** Composition API (script setup)
...
### VehicleSearchView
**Path:** `src/views/autocare/vcdb/VehicleSearchView.vue`
**Type:** Composition API (script setup)
...
### notification.types
**Path:** `src/utils/notification/notification.types.ts`
...
### padb
**Path:** `src/types/autocare/padb.ts`
...
#### Interface: `AttributeSearchResponse`
| Property | Type |
| -------- | ---- |
| items | PartAttribute[] |
| page | number |
...
#### Interface: `MeasurementGroup` extends BaseEntity
| Property | Type |
| -------- | ---- |
| measurement_group_id | number |
| measurement_group_name | string |

#### Interface: `MetaData` extends BaseEntity
| Property | Type |
| -------- | ---- |
| data_type | string |
| max_length | number |
...
#### Interface: `MetaUOMCode` extends BaseEntity
| Property | Type |
| -------- | ---- |
| measurement_group_id | number |
| meta_uom_id | number |
...
#### Interface: `PartAttribute` extends BaseEntity
| Property | Type |
| -------- | ---- |
| pa_descr | string |
| pa_id | number |
...
#### Interface: `PartAttributeAssignment` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `PartAttributeDetail` extends BaseEntity
| Property | Type |
| -------- | ---- |
| data_type | string |
| description | string |
...
#### Interface: `PartAttributesResponse`
| Property | Type |
| -------- | ---- |
| attributes | AttributeWithMetadata[] |
| part_terminology_id | number |

#### Interface: `ValidValue` extends BaseEntity
| Property | Type |
| -------- | ---- |
| valid_value | string |
...
### pcdb
**Path:** `src/types/autocare/pcdb.ts`
...
### qdb
**Path:** `src/types/autocare/qdb.ts`

#### Interface: `GroupNumber` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `Qualifier` extends BaseEntity
| Property | Type |
| -------- | ---- |
| example_text | string |
...
#### Interface: `QualifierGroup` extends BaseEntity
| Property | Type |
| -------- | ---- |
| description | string |
| group_number_id | number |
...
#### Interface: `QualifierSearchResponse`
| Property | Type |
| -------- | ---- |
| items | Qualifier[] |
| page | number |
...
#### Interface: `QualifierTranslation` extends BaseEntity
| Property | Type |
| -------- | ---- |
| dialect | string |
| language | {
...
#### Interface: `QualifierType` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
### vcdb
**Path:** `src/types/autocare/vcdb.ts`

#### Interface: `Aspiration` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `BaseVehicle` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `BodyNumDoors` extends BaseEntity
| Property | Type |
| -------- | ---- |
| body_num_doors_id | number |
| num_doors | string |

#### Interface: `BodyStyleConfig` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `BodyType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| body_type_id | number |
| name | string |

#### Interface: `BrakeABS` extends BaseEntity
| Property | Type |
| -------- | ---- |
| brake_abs_id | number |
| name | string |

#### Interface: `BrakeConfig` extends BaseEntity
| Property | Type |
| -------- | ---- |
| brake_abs | BrakeABS |
| brake_abs_id | number |
...
#### Interface: `BrakeSystem` extends BaseEntity
| Property | Type |
| -------- | ---- |
| brake_system_id | number |
| name | string |

#### Interface: `BrakeType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| brake_type_id | number |
| name | string |

#### Interface: `CylinderHeadType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| cylinder_head_type_id | number |
| name | string |

#### Interface: `DriveType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| drive_type_id | number |
| name | string |

#### Interface: `EngineBase` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `EngineBlock` extends BaseEntity
| Property | Type |
| -------- | ---- |
| block_type | string |
| cc | string |
...
#### Interface: `EngineBoreStroke` extends BaseEntity
| Property | Type |
| -------- | ---- |
| bore_in | string |
| bore_metric | string |
...
#### Interface: `EngineConfig` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `FuelType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| fuel_type_id | number |
| name | string |

#### Interface: `Make` extends BaseEntity
| Property | Type |
| -------- | ---- |
| make_id | number |
| name | string |
...
#### Interface: `PowerOutput` extends BaseEntity
| Property | Type |
| -------- | ---- |
| horsepower | string |
| kilowatt | string |
...
#### Interface: `SubModel` extends BaseEntity
| Property | Type |
| -------- | ---- |
| name | string |
| submodel_id | number |

#### Interface: `Transmission` extends BaseEntity
| Property | Type |
| -------- | ---- |
...
#### Interface: `TransmissionBase` extends BaseEntity
| Property | Type |
| -------- | ---- |
| transmission_base_id | number |
...
#### Interface: `TransmissionControlType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| name | string |
| transmission_control_type_id | number |
...
#### Interface: `TransmissionNumSpeeds` extends BaseEntity
| Property | Type |
| -------- | ---- |
| num_speeds | string |
| transmission_num_speeds_id | number |

#### Interface: `TransmissionType` extends BaseEntity
| Property | Type |
| -------- | ---- |
| name | string |
| transmission_type_id | number |
...
#### Interface: `Valves` extends BaseEntity
| Property | Type |
| -------- | ---- |
| valves_id | number |
...
#### Interface: `WheelBase` extends BaseEntity
| Property | Type |
| -------- | ---- |
| wheel_base | string |
...
### enhancedDataTable
**Path:** `src/components/data/enhancedDataTable.ts`
...
#### Function: `formatEngineDescription(liter?: string | null, cylinders?: string | null, aspiration?: string | null, fuelType?: string | null) → string`

#### Function: `formatFileSize(bytes: number, decimals: number = 2) → string`

#### Function: `formatNumber(num: number, decimals: number = 0) → string`

#### Function: `formatTransmissionDescription(type?: string | null, speeds?: string | null, controlType?: string | null) → string`

#### Function: `formatVehicleName(year?: number | null, make?: string | null, model?: string | null, submodel?: string | null) → string`
...
**Path:** `src/utils/notification/notification.service.ts`
...
#### Function: `createNotification(type: NotificationType, message: string, options: NotificationOptions = {}) → number`
...
### padb.store
**Path:** `src/stores/autocare/padb.store.ts`

#### Function: `clearAttribute()`

#### Function: `clearError()`

#### Function: `clearPartAttributes()`

#### Function: `clearSearch()`

#### Function: `fetchAttributeDetails(paId: number)`

#### Function: `fetchMeasurementGroups()`

#### Function: `fetchPartAttributes(partTerminologyId: number)`

#### Function: `fetchStats()`

#### Function: `fetchUOMCodesByGroup(measurementGroupId: number)`

#### Function: `fetchValidValuesForAttribute(paptId: number)`

#### Function: `fetchVersion()`

#### Function: `getUOMCodesByGroup(groupId: number)`

#### Function: `searchAttributes(params: AttributeSearchParams)`

#### Function: `setError(err: ApiError)`

#### Function: `setLoading(value: boolean)`

### pcdb.store
**Path:** `src/stores/autocare/pcdb.store.ts`

#### Function: `addSelectedCategory(categoryId: number)`
...
#### Function: `fetchPartDetails(partTerminologyId: number)`

#### Function: `fetchPartsByCategory(categoryId: number, page: number = 1, pageSize: number = 20)`

#### Function: `fetchPositions()`

#### Function: `fetchPositionsByPart(partTerminologyId: number)`

#### Function: `fetchStats()`

#### Function: `fetchSubcategoriesByCategory(categoryId: number)`

#### Function: `fetchVersion()`

#### Function: `removeSelectedCategory(categoryId: number)`

#### Function: `searchCategories(searchTerm: string)`

#### Function: `searchParts(params: PartSearchParams)`

#### Function: `setError(err: ApiError)`

#### Function: `setLoading(value: boolean)`

#### Function: `setSelectedCategories(categoryIds: number[])`

### qdb.store
**Path:** `src/stores/autocare/qdb.store.ts`
...
#### Function: `fetchQualifierDetails(qualifierId: number)`

#### Function: `fetchQualifierGroups(qualifierId: number)`

#### Function: `fetchQualifierTranslations(qualifierId: number, languageId?: number)`

#### Function: `fetchQualifierTypes()`

#### Function: `fetchQualifiersByGroup(groupNumberId: number, page: number = 1, pageSize: number = 20)`

#### Function: `fetchStats()`

#### Function: `fetchVersion()`

#### Function: `searchQualifiers(params: QualifierSearchParams)`

#### Function: `setError(err: ApiError)`

#### Function: `setLoading(value: boolean)`

#### Function: `setSelectedLanguage(langId: number | null)`

#### Function: `setSelectedQualifierType(typeId: number | null)`
...
#### Function: `useChartData(options: ChartDataOptions<T> = {})`

### useFormValidation
**Path:** `src/composables/useFormValidation.ts`

#### Function: `handleSubmit(submitFn: (data, any>) => Promise<any> | void)`
...
#### Function: `isDateInFuture(value: Date | string | number | null | undefined) → boolean`

#### Function: `isDateInPast(value: Date | string | number | null | undefined) → boolean`
...
#### Function: `isNonEmptyArray(value: T[] | null | undefined) → value is T[]`

#### Function: `isNonNegativeNumber(value: number | null | undefined) → value is number`

#### Function: `isPositiveNumber(value: number | null | undefined) → value is number`

#### Function: `isValidDate(value: Date | string | number | null | undefined) → boolean`

#### Function: `isValidEmail(value: string | null | undefined) → boolean`

#### Function: `isValidMakeId(value: number | null | undefined) → boolean`

#### Function: `isValidModelId(value: number | null | undefined) → boolean`

#### Function: `isValidNumber(value: number | null | undefined) → value is number`

#### Function: `isValidPartTerminologyId(value: number | null | undefined) → boolean`

#### Function: `isValidQualifierId(value: number | null | undefined) → boolean`

#### Function: `isValidUrl(value: string | null | undefined) → boolean`

#### Function: `isValidYear(value: number | null | undefined) → boolean`

### vcdb.store
**Path:** `src/stores/autocare/vcdb.store.ts`
...
#### Function: `fetchAllSubmodels()`

#### Function: `fetchMakes()`

#### Function: `fetchMakesByYear(year: number)`

#### Function: `fetchModelsByYearMake(year: number, makeId: number)`

#### Function: `fetchRegions()`

#### Function: `fetchStats()`

#### Function: `fetchSubmodelsByBaseVehicle(baseVehicleId: number)`

#### Function: `fetchVehicleConfigurations(vehicleId: number)`

#### Function: `fetchVehicleDetails(vehicleId: number)`

#### Function: `fetchVehicleTypes()`

#### Function: `fetchVehicleTypesByGroup(groupId: number)`
...
#### Function: `findBaseVehicle(yearId: number, makeId: number, modelId: number) → Promise<BaseVehicle | null>`

#### Function: `searchMakes(searchTerm: string)`

#### Function: `searchModels(searchTerm: string)`

#### Function: `searchSubmodels(searchTerm: string)`

#### Function: `searchVehicles(params: VehicleSearchParams)`
