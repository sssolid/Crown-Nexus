...
class Media(Base):
    ...
    products: Mapped[List['Product']] = relationship('app.models.product.Product', secondary=product_media_association, back_populates='media')
    uploaded_by: Mapped['User'] = relationship('User', foreign_keys=[uploaded_by_id], backref='uploaded_media')
    approved_by: Mapped[Optional['User']] = relationship('User', foreign_keys=[approved_by_id], backref='approved_media')
